...
function syncAdaptiveNavigation(){
  ...
  if(desktopMore){
    desktopMore.innerHTML=model.secondary.map(([r,l])=>navButtonMarkup(r,l,{menu:true})).join('');
  }
  ...
  if(mobileMenu){
    ...
    mobileMenu.innerHTML=
      (allSecondary.length
        ? `<div class="mobile-menu-section-label">More healthcare</div>${allSecondary.map(([r,l])=>navButtonMarkup(r,l,{menu:true})).join('')}`
        : '')+
      (currentUser
