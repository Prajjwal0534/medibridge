    ...
    <div class="pharmacy-discovery-card">
      ...
      <div class="pharmacy-discovery-main">
        ...
        <div class="row" style="margin-top:8px">
          ${safeGoogleMapsUrl(p.google_maps_url)?`<button class="btn secondary" onclick="openEncodedExternalUrl('${encodeURIComponent(safeGoogleMapsUrl(p.google_maps_url))}','google_maps')">Open Maps</button>`:''}
        </div>
      </div>
    </div>
  `).join('');
