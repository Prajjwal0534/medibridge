  ...
  box.innerHTML=filtered.map(d=>{
    ...
    return `<div class="card doctor-card">
      <div class="row between">
        ...
        <div class="row">
          ${safeGoogleMapsUrl(mapLink)?`<button class="btn secondary" onclick="openEncodedExternalUrl('${encodeURIComponent(safeGoogleMapsUrl(mapLink))}','google_maps')">Location</button>`:''}
...
function renderEmergencyHospitalResults(results,context){
  ...
  box.innerHTML=results.map(h=>{
    ...
    return `<div class="card hospital-result">
      ...
      <div class="row">
        ${mapsLink?`<button class="btn secondary" onclick="openEncodedExternalUrl('${encodeURIComponent(mapsLink)}','google_maps')">Open location</button>`:''}
